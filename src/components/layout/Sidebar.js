...
const Sidebar = () => {
    ...
    return (_jsxs("aside", { className: "w-64 bg-white shadow-md", children: [_jsx("div", { className: "p-4 border-b", children: _jsx("h1", { className: "text-xl font-semibold text-gray-800", children: "\uAD00\uB9AC \uC2DC\uC2A4\uD15C" }) }), _jsx("nav", { className: "mt-4", children: _jsx("ul", { children: navigationItems.map(({ path, label, icon: Icon }) => (_jsx("li", { children: _jsxs(Link, { to: path, className: `flex items-center px-4 py-3 hover:bg-gray-100 transition-colors ${isActive(path) ? 'bg-blue-50 text-blue-600 border-r-2 border-blue-600' : 'text-gray-700'}`, children: [_jsx(Icon, { className: "mr-3" }), _jsx("span", { children: label })] }) }, path))) }) })] }));
};
